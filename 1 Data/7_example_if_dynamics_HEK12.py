...
for (cas, ts) in zip(cas_plot, ts_plot):
    ...
    ax2.arrow(x=ts[-1], y=caT, dx=0, dy=0.6 - caT, color="k", length_includes_head=True, head_width=12., head_length=0.04)
...
plt.savefig(
        home + "/Data/calcium/experimental/Spikes/HEK/Plots2/Traces/HEK2_bapta_if_dynamics{:d}.png".format(j), dpi=300, transparent=True)
