...
if __name__ == "__main__":
    ...
    ax_a1.text(0.05, 1.00, r"A$_1$", fontsize=11, transform=ax_a1.transAxes, va='top')
    ax_a2.text(0.15, 1.00, r"A$_2$", fontsize=11, transform=ax_a2.transAxes, va='top')
    ax_a3.text(0.15, 1.00, r"A$_3$", fontsize=11, transform=ax_a3.transAxes, va='top')
    ax_a4.text(0.15, 1.00, r"A$_4$", fontsize=11, transform=ax_a4.transAxes, va='top')
    ax_a5.text(0.15, 1.00, r"A$_5$", fontsize=11, transform=ax_a5.transAxes, va='top')

    ax_b1.text(0.085, 1.00, r"B$_1$", fontsize=11, transform=ax_b1.transAxes, va='top')
    ax_b2.text(0.15, 1.00, r"B$_2$", fontsize=11, transform=ax_b2.transAxes, va='top')
    ax_b3.text(0.15, 1.00, r"B$_3$", fontsize=11, transform=ax_b3.transAxes, va='top')
    ax_b4.text(0.15, 1.00, r"B$_4$", fontsize=11, transform=ax_b4.transAxes, va='top')
    ax_b5.text(0.15, 1.00, r"B$_5$", fontsize=11, transform=ax_b5.transAxes, va='top')
