...
if __name__ == "__main__":
    ...
    ax1.text(0.1, 0.1, r"C$_1$", fontsize=11, transform=ax1.transAxes)
    ax2.text(0.1, 0.1, r"C$_2$", fontsize=11, transform=ax2.transAxes)
    ax3.text(0.1, 0.1, r"C$_3$", fontsize=11, transform=ax3.transAxes)
    ax4.text(0.1, 0.1, r"D$_1$", fontsize=11, transform=ax4.transAxes)
    ax5.text(0.1, 0.1, r"D$_2$", fontsize=11, transform=ax5.transAxes)
    ax6.text(0.1, 0.1, r"D$_3$", fontsize=11, transform=ax6.transAxes)
    colors = st.Colors()
    ...
    cbar1.set_label(r"$\delta T$", loc="center")

    cbar2 = fig.colorbar(cs2, ax=axes_cv, orientation='vertical')
    cbar2.set_ticks([-0.5, 0., 0.5])
    cbar2.set_label(r"$\delta C_V(T)$", loc="center")
    plt.savefig(home + f"/Dropbox/LUKAS_BENJAMIN/RamLin22_1_BiophysJ/SUB2/figures/fig6b.pdf", transparent=True)
    plt.show()
