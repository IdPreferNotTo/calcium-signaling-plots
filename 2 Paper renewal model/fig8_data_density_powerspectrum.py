...
if __name__ == "__main__":
    ...
    ax2.text(0.10, 0.95, "B", fontsize=11, transform=ax2.transAxes, va='top')
    ax3.text(0.15, 0.95, "C", fontsize=11, transform=ax3.transAxes, va='top')
    ax4.text(0.15, 0.95, "D", fontsize=11, transform=ax4.transAxes, va='top')
    ...
    tmax = max(ISIs_flat)
    ax2.hist(ISIs_flat, color=st.colors[5], bins=20, alpha=1.0, density=True, zorder=2, label="HEK")
    ...
    ax2.legend(fancybox=False, loc=1, fontsize=8, framealpha=1.)

    #plt.savefig(home + f"/Dropbox/LUKAS_BENJAMIN/RamLin22_1_BiophysJ/SUB2/figures/fig8.pdf", transparent=True)
    plt.show()
