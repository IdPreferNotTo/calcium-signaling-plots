...
if __name__ == "__main__":
    ...
    ax_mean_markov.text(0.1, 0.1, r"A", fontsize=11, transform=ax_mean_markov.transAxes)
    ax_cv_markov.text(0.1, 0.1, r"B", fontsize=11, transform=ax_cv_markov.transAxes)

    ax_cv_markov.text(0.65, 0.65, "mean-driven", fontsize=10, rotation=-41, transform=ax_cv_markov.transAxes, ha="center", va="center")
    ax_cv_markov.text(0.25, 0.25, "excitable", fontsize=10, rotation=-41, transform=ax_cv_markov.transAxes, ha="center", va="center")
    ...
    cbar_cv_markov.set_label(r"$C_V(T)$", loc="center")
    ...
    plt.savefig(home + f"/Dropbox/LUKAS_BENJAMIN/RamLin22_1_BiophysJ/SUB2/figures/fig6a.pdf", transparent=True)
    plt.show()
