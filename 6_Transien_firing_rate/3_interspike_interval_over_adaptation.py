...
if __name__ == "__main__":
    ...
    folder = "/CLionProjects/PhD/calcium_spikes_markov/Data_adap"
    r0s_renewal = []
    t0s_renewal = []
    r0s_refrac = []
    t0s_refrac = []
    ...
    for i in range(100):
        j = 0.2*(i/100)
        js.append(j)
        r0 = np.loadtxt(home + f"/Data/Calcium/data/r0_ip1.00_tau2.00e+00_j{j:.2e}_N10.dat")
    ...
    plt.savefig(home + f"/Data/Calcium/Plots/f-I_curve.pdf", transparent=True)
    plt.show()
