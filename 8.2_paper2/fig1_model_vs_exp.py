...
if __name__ == "__main__":
    ...
    ax3.text(0.6, 1.00, "Model", fontsize=11, transform=ax3.transAxes, ha="center", va='top')
    ...
    ax2.scatter(index_ISIs, ISIs, fc="w", ec=st.colors[5], s=20, zorder=2)
    ax2.plot(i_ISI_fit, ISI_fit, lw=1, c="k", zorder=3)
    ax2.fill_between([0, popt[2]], [0, 0], [200, 200], color="C7", alpha=0.3, zorder=1)
    ax2.axhline(popt[0], ls=":", lw=1, c="k")
    ax2.axhline(popt[1], ls=":", lw=1, c="k")
    # ax2.text(nr_ISIs - 7, popt[0]*1.2, "$T_0$", ha="center")
    # ax2.text(nr_ISIs - 7, 100, "$T_\infty$", ha="center")
    ...
    ax4.fill_between([0, popt[2]], [0, 0], [200, 200], color="C7", alpha=0.3, zorder=1)
    ...
    ax4.plot(index_ISIs, ISI_fit, lw=1, c="k", zorder=3)
    ax4.axhline(popt[0], ls=":", lw=1, c="k")
