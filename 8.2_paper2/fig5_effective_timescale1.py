...
if __name__ == "__main__":
    ...
    ax2.plot(ts[1_000:11_000]-100, cers[1_000:11_000], c="C7", lw=1, zorder=1)
    ts_spike = []
    for t, c, j in zip(ts, cs, js):
        if j == 69:
            ts_spike.append(t)
    for t_spike in ts_spike[:12]:
        ax0.plot([t_spike-100, t_spike-100], [0.2, 0.8], lw=1, c="k")
