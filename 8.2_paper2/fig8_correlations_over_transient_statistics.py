...
if __name__ == "__main__":
    ...
    scat1 = ax1.scatter(n_trs, p1s, fc="w", ec=st.colors[0], s=20, zorder=3)
    scat2 = ax2.scatter(dTs, p1s, fc="w", ec=st.colors[0], s=20, zorder=3)
    ...
    scat1 = ax3.scatter(n_trs, p1s, fc="w", ec=st.colors[0], s=20, zorder=3)
    scat2 = ax4.scatter(dTs, p1s, fc="w", ec=st.colors[0], s=20, zorder=3)
