...
if __name__ == "__main__":
    ...
    file = home + "/Data/calcium_spikes_experimental/Spikes/HEK/HEK2_bapta_ratio.dat"
    ...
    ax3.text(5, 90, r"$\alpha = e^{-T_\infty/\tau_a}(1 - \epsilon)$", ha="left", va="center", fontsize = 15)
