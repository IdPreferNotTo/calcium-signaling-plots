...
if __name__ == "__main__":
    ...
    for k, (tau, j) in enumerate(zip(taus, js)):
        ...
        im1 = ax1.scatter(IP3s[::2], rates_markov[::2], s=20, c=cvs_markov[::2], cmap=cmap_viridis, vmin=-0.05, vmax=1.05, label="Sim.")
        ...
        for n, IP3 in enumerate(IP3s_density[k]):
            ...
            if k == 0:
                ...
                bins = 50
            ax2.hist(isis_markov, bins=bins, color=plt_color, density=True, alpha=0.2 + 0.3*(2-n), label=f"$s = {IP3:.2f}$")
