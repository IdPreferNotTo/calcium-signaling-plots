...
if __name__ == "__main__":
    ...
    cs1 = ax1.pcolormesh(taus, js, ISI_markov, linewidth=0, rasterized=True, vmin=0., vmax=200.0,  cmap=cm.cividis)#, norm=mcolors.SymLogNorm(linthresh=0.01, vmin=0., vmax=1))
    ...
    cs2 = ax2.pcolormesh(taus, js, dif_ISI, linewidth=0, rasterized=True, vmin=-0.2, vmax=0.2, cmap=cm.coolwarm)
    ...
    cs3 = ax3.pcolormesh(taus, js, CV_markov, linewidth=0, rasterized=True, vmin=0., vmax=1.0, cmap=cm.cividis)
    ...
    cs4 = ax4.pcolormesh(taus, js, dif_CV, linewidth=0, rasterized=True, vmin=-0.4, vmax=0.4, cmap=cm.coolwarm)
    # , norm=mcolors.SymLogNorm(linthresh=0.01, vmin=0., vmax=1))
