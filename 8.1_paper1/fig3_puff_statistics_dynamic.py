...
if __name__ == "__main__":
    ...
    ax1.text(0.55, 0.80, "$s = 10$", fontsize=11, transform=ax1.transAxes, va='top')
    ...
    plt.savefig(home + f"/Dropbox/LUKAS_BENJAMIN/RamLin22_1_BiophysJ/SUB1/figures/fig3.pdf",transparent=True)
    plt.show()