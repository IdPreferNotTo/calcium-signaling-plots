...
if __name__ == "__main__":
    ...
    for i, ca in enumerate([ca1, ca2]):
        ...
        if ca == ca1:
            ...
            ax4.plot(fc.gaussian_dist(gaus2, mean_jpuff, std_jpuff_f2), gaus2, c=color.palette[5], lw=1.)
        ...
        if ca == ca2:
            ...
            ax8.plot(fc.gaussian_dist(gaus2, mean_jpuff, std_jpuff_f2), gaus2, c=color.palette[5], lw=1.)
